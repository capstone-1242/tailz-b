...
<body <?php body_class( 'bg-white text-gray-900 antialiased font-worksans' ); ?>>
	...
	<div id="page" class="min-h-screen flex flex-col">
		...
		<header class="site-header bg-[#2B3FB8] sticky top-0 left-0 right-0 w-full z-30" role="banner">
			...
			$banner_text = get_post_meta(get_the_ID(), '_tailz_banner_text', true);
			
			if ($banner_enabled === 'on' && !empty($banner_text)) : ?>
			<div class="w-full bg-[#FEA91D] text-white" role="alert" aria-live="polite" aria-atomic="true">
				<div class="container mx-auto px-4">
					<div class="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left py-3">
						...
						<div class="flex items-center font-worksans text-lg">
							...
							<address class="not-italic">12004 111 Ave NW, Edmonton, AB</address>
						</div>
					</div>
				</div>
			</div>
	...
	<main id="content" class="site-content flex-grow pt-[80px]">
