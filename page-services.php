...
<div class="flex flex-col lg:grid lg:grid-cols-2 gap-[30px] mx-6 lg:mx-[89px] mb-6 lg:mb-[89px]">
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('grooming'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-grooming-photo.jpg'); ?>" alt="Photo of a dog getting groomed">
            </div>
            <div class="bg-[#FF6A6A] flex flex-col gap-[20px] lg:gap-[47px] pt-[20px] pb-[33px] px-[17px] lg:pt-[30px] pb-[62px] lg:px-[40px] rounded-b-[30px]">
                <div class="flex flex-col gap-[7.85px] lg:gap-[20px]">
    ...
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('daycare'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-daycare-photo.jpg'); ?>" alt="Photo of a dog in a dog playground">
            </div>
    ...
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('hotel'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-hotel-photo.jpg'); ?>" alt="Photo of a dog in a dog bed">
            </div>
    ...
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('training'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-training-photo.jpg'); ?>" alt="Photo of a man training a dog">
            </div>
    ...
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('exercise'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-exercise-photo.jpg'); ?>" alt="Photo of a dog doing a stretch">
            </div>
    ...
    <div class="group">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('portraits'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-portraits-photo.jpg'); ?>" alt="Portrait of a dog">
            </div>
    ...
    <div class="group lg:col-span-2">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('puppy-programs'))); ?>" class="block transition-all duration-300 hover:scale-[1.02]">
            <div class="rounded-t-[30px] overflow-hidden">
                <img class="w-full rounded-t-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/images/services-puppy-programs-photo.jpg'); ?>" alt="Photo of a pile of puppies">
            </div>
            <div class="bg-[#FF8ECC] flex flex-col gap-[20px] lg:gap-[47px] pt-[20px] pb-[33px] px-[17px] lg:pt-[30px] pb-[62px] lg:px-[40px] rounded-b-[30px] transition-all duration-300 group-hover:shadow-xl group-hover:shadow-[#CB93FF]/30">
                <div class="flex flex-col gap-[7.85px] lg:gap-[20px]">
