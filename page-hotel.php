...
<div class="container mx-auto my-8">
    ...
    <section class="flex flex-col gap-3 mt-8">
        <h2 class="uppercase font-bold">Hotel</h2>
        ...
        <div>
            <div>
                ...
                <p>You've earned your time off, but travel isn't always pet-friendly. Luckily, Tailz offers safe and comfortable overnight lodging for your dog!</p>
            </div>
            <div>
                <h3>two in one</h3>
                <p>At Tailz, overnight stays include all the perks of doggy daycare plus extra bedtime care! Your pup enjoys a full day of play, restful sleep in a comfy suite, and wakes up ready for more fun. Every overnight stay includes a full day of daycare!</p>
                <p>We provide blankets, beds, bowls, and toys - just bring their food! Note: Personal items may get damaged.</p>
                <p>Enjoy peace of mind knowing your pet is well cared for.</p>
            </div>
