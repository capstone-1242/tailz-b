...
try {
    if ( function_exists('get_field') ) {
        ...
        // Process each service from the "grooming_services" group.
        if ( $grooming ) {
            // Update array to check for four services
            $service_keys = array('service_1', 'service_2', 'service_3', 'service_4');
            foreach ( $service_keys as $sk ) {
                if ( !empty($grooming[$sk]) ) {
                    $s = $grooming[$sk];
                    
                    // Build includes array using up to 5 includes (adjust if needed)
                    $includes = array();
                        ...
                        <div class="flex-grow">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-[1fr_1fr_300px] gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2" role="list">
                                    ...
                                    foreach ( $services_array as $service ) :
                                        ...
                                        // Optionally set a colspan for specific cards if needed
                                        ...
                                        <div class="service-card bg-white border border-gray-300 p-6 rounded-[20px]<?php echo $colspan; ?>" <?php echo $data_attrs; ?> role="listitem">
                                            <div class="flex justify-between items-start mb-4">
                                                ...
                                                <div class="price text-xl font-bold text-[#47423B]">
                                                    <?php 
                                                    // Display dog's "M" size price, or "N/A" if not set
                            ...
                            <div class="max-w-[600px] mx-auto text-center mt-12">
                                ...
                                <button class="self-start">
                                    <a class="rounded-[40px] bg-[#FF8ECC] px-[20px] py-[11px] lowercase text-white hover:bg-white hover:text-[#FF8ECC] border-2 border-[#FF8ECC] transition-all duration-300 font-bold" href="https://booking.moego.pet/ol/book?name=Tailz">
                                        Book now
                                    </a>
                                </button>
                            </div>
