            ...
            <div class="flex flex-col">
                <div class="relative w-full h-screen max-h-[15.75rem] lg:max-h-[50rem] overflow-hidden">
                    ...
                    <div class="flex flex-col gap-[10px] lg:gap-[30px] absolute inset-0 mx-6 lg:mx-[89px] py-6 lg:py-[89px] justify-end">
                        ...
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('exercise'))); ?>" class="text-[#FFFFFF] text-[18px] lg:text-[24px] bg-[#6FDBFC] py-[5px] px-[22px] lg:py-[16px] lg:px-[40px] rounded-[30px] w-fit hover:bg-[#5ac5e6] transition-colors font-bold lowercase">Learn more in exercise</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="hero-banner new-facility">
                <div class="hero-banner-content">
                    ...
                    <p class="text-[#6FDBFC] text-[24px] lg:text-[42.65px] font-bold">Doggy swim!</p>
                    <p class="text-[#FFFFFF] text-[18px] lg:text-[24px]">Find out more about doggy swim on our exercise page!</p>
                    <a class="text-[#FFFFFF] text-[18px] lg:text-[24px] bg-[#6FDBFC] py-[5px] px-[22px] lg:py-[16px] lg:px-[40px] rounded-[30px] w-fit hover:bg-[#5ac5e6] transition-colors">Learn more</a>
                </div>
            </div>
        </section>
