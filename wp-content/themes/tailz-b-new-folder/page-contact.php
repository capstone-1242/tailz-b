...
<div class="hidden md:block">
  ...
  <div class="curved-image-container">
    ...
    <div class="container mx-auto px-6 md:px-[90px] content-container">
      <div class="max-w-[600px]">
        <h1 class="font-poppins font-bold text-[134.6px] leading-none text-white lowercase">
          contact
        </h1>
        <p class="font-worksans font-normal text-[24px] leading-tight text-white uppercase mt-4 max-w-[400px]">
          We'll be happy to give you a paw when you need it!
        </p>
      </div>
    </div>
