<footer id="colophon" class="site-footer m-0 p-0 mt-[60px] lg:mt-[130px]" role="contentinfo">
    ...
    <section aria-label="Call-to-Action" class="bg-white">
        <div class="mx-[24px] lg:mx-[90px]">
            <h2 class="font-poppins font-bold text-[38px] md:text-[75.78px]  uppercase text-[#FEA91D] leading-6 md:leading-[3.1rem]">
                stop in at tailz
            </h2>
        </div>
    </section>
    ...
    <section aria-label="Footer Information" class="bg-[#FEA91D]">
        <div class="px-[24px] lg:px-[90px] py-[40px] lg:py-[60px]">
            <div class="lg:flex">
                <!-- Hours & Address Container -->
                <div class="flex flex-col md:flex-row md:justify-between md:gap-x-16 lg:pr-12">
                    <!-- Hours -->
                    <div class="mb-8 md:mb-0">
                        <h3 class="font-poppins font-bold text-[32px] md:text-[42.65px] text-white lowercase mb-4 md:mb-6">hours</h3>
                        <div class="font-worksans text-[20px] md:text-[24px] text-white">
                            <dl class="space-y-4">
                                <div class="flex justify-between items-center">
                                    <dt class="pr-8">Monday - Friday</dt>
                    ...
                    <div>
                        ...
                        <address class="font-worksans text-[20px] md:text-[24px] not-italic text-white space-y-3">
                            12004 111 Ave NW<br>
                ...
                <div class="flex-1 min-h-[300px] mt-10 lg:mt-0">
        ...
        <div class="container mx-auto px-6 sm:px-4">
            ...
            <div class="md:grid md:grid-cols-[250px_1fr] md:gap-16 items-start">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <h2 class="font-worksans text-[24px] md:text-[31.99px] text-white mb-6 md:mb-8 lowercase pb-4 border-b-2 border-white">what we offer</h2>
                    ...
                    <div class="mt-8 md:mt-0">
                        <h2 class="font-worksans text-[24px] md:text-[31.99px] text-white mb-6 md:mb-8 lowercase pb-4 border-b-2 border-white">who we are</h2>
                        ...
                        <div class="grid grid-cols-2 gap-6 md:gap-4">
                            ...
                            <div>
                                ...
                                <a href="<?php echo esc_url(home_url('/contact')); ?>"
                                    class="inline-block bg-[#FEA91D] text-white font-worksans font-bold text-[16px] lg:text-[18px] py-2 px-6 rounded-full hover:bg-[#e0881a] transition-colors">
                                    contact page
                                </a>
                            </div>
                        </div>
    ...
    <div class="bg-[#1E2B79] text-white py-2 lg:py-3">
        <div class="container mx-auto px-6 sm:px-4">
            <div class="flex flex-col sm:flex-row justify-center md:justify-start items-center gap-4 md:gap-6">
                <span class="font-worksans font-bold text-base">© <?php echo date("Y"); ?> <span class="font-bold">TAILZ</span></span>
