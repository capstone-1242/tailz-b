  ...
  <nav class="container mx-auto px-6 md:px-[90px] pt-4 pb-8 md:pt-6 md:pb-12" aria-label="Breadcrumb">
    <ol class="flex items-center text-[16px] md:text-[24px] leading-none text-[#2C2C2C]" itemscope itemtype="https://schema.org/BreadcrumbList">
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <a href="<?php echo home_url(); ?>" class="font-poppins font-normal hover:opacity-80 transition-opacity" itemprop="item">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <a href="<?php echo home_url('/services'); ?>" class="font-poppins font-normal hover:opacity-80 transition-opacity" itemprop="item">
...
<div class="block md:hidden">
  <div class="container mx-auto px-6">
    <!-- Hours -->
    <section class="mb-12">
      <h2 class="font-poppins font-bold text-[37px] text-[#47423B] lowercase mb-6">
        hours
      </h2>
      <div class="space-y-4">
        <div class="flex items-center">
          <span class="font-worksans text-[16px] uppercase text-[#2C2C2C] w-[160px]">MONDAY - FRIDAY</span>
          <span class="font-worksans text-[16px] uppercase text-[#2C2C2C]">6:30am - 6:30pm</span>
        </div>
        <div class="flex items-center">
          <span class="font-worksans text-[16px] uppercase text-[#2C2C2C] w-[160px]">SATURDAY</span>
          <span class="font-worksans text-[16px] uppercase text-[#2C2C2C]">10:00am - 5:00pm</span>
        </div>
        <p class="font-worksans text-[16px] italic text-[#2C2C2C]">
    ...
    <section class="mb-12">
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="tel:+1-780-988-0089" class="font-worksans text-[16px] text-[#2C2C2C]">
          780-988-0089
        </a>
      </div>
    </section>
    ...
    <section class="mb-12">
      ...
      <address class="not-italic">
        <a href="https://www.google.com/maps/place/Tailz/@53.5725,-113.5725,17z/" 
           ...
           class="font-worksans text-[16px] text-[#2C2C2C] lowercase">
    ...
    <!-- Mobile Form Section -->
    <section class="mb-8">
      <div class="bg-[#F3F2EC] rounded-[30px] p-6 max-w-[500px] mx-auto">
...
<!-- Desktop Layout -->
<div class="hidden md:block">
  <div class="container mx-auto px-[90px] py-10">
    <div class="grid grid-cols-2 gap-x-[200px] gap-y-[100px] w-[70%]">
      <!-- Hours -->
      <section>
        <h2 class="font-poppins font-bold text-[75.8px] text-[#47423B] lowercase mb-8">
          hours
        </h2>
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            <span class="font-worksans text-[24px] uppercase text-[#2C2C2C]">MONDAY - FRIDAY</span>
            <span class="font-worksans text-[24px] uppercase text-[#2C2C2C]">6:30am - 6:30pm</span>
          </div>
          <div class="flex justify-between items-center">
            <span class="font-worksans text-[24px] uppercase text-[#2C2C2C]">SATURDAY</span>
            <span class="font-worksans text-[24px] uppercase text-[#2C2C2C]">10:00am - 5:00pm</span>
          </div>
          <p class="font-worksans text-[24px] italic text-[#2C2C2C]">
            Closed Sundays and Holidays
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="flex items-center gap-4">
          <svg width="54" height="54" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.3125 10.0208C2.3125 5.76352 5.76352 2.3125 10.0208 2.3125H10.4594C10.9216 2.31258 11.3731 2.45111 11.7557 2.71024C12.1384 2.96937 12.4346 3.3372 12.6062 3.76629L14.5071 8.51771C14.7312 9.07794 14.7861 9.69163 14.6648 10.2827C14.5436 10.8738 14.2515 11.4164 13.8249 11.8431L11.453 14.2149C11.073 14.595 10.9135 15.1476 11.0692 15.6626C11.8083 18.0842 13.1313 20.2872 14.9217 22.0775C16.7121 23.8679 18.915 25.1909 21.3367 25.9301C21.8516 26.0865 22.4043 25.9262 22.7843 25.5462L25.1561 23.1743C25.5829 22.7477 26.1254 22.4557 26.7165 22.3344C27.3076 22.2131 27.9213 22.268 28.4815 22.4921L33.2337 24.393C33.6628 24.5646 34.0306 24.8609 34.2898 25.2435C34.5489 25.6261 34.6874 26.0777 34.6875 26.5398V26.9792C34.6875 31.2365 31.2365 34.6875 26.9792 34.6875H26.5938C13.4048 34.6875 2.67171 24.1718 2.32098 11.0676C2.32098 11.0638 2.31944 11.0599 2.31713 11.0576C2.31571 11.0563 2.31457 11.0548 2.31377 11.0531C2.31298 11.0513 2.31255 11.0495 2.3125 11.0476V10.0208Z" stroke="#2C2C2C" stroke-width="4" stroke-linejoin="round"/>
          </svg>
          <a href="tel:+1-780-988-0089" class="font-worksans text-[24px] text-[#2C2C2C]">
            780-988-0089
          </a>
        </div>
      </section>
      ...
      <section>
        ...
        <address class="not-italic">
          <a href="https://www.google.com/maps/place/Tailz/@53.5725,-113.5725,17z/" 
             target="_blank" 
             rel="noopener noreferrer"
             class="font-worksans text-[24px] text-[#2C2C2C] lowercase">
            12004 111 ave nw, edmonton
          </a>
        </address>
      </section>
    ...
    <!-- Send Us An Email -->
    <section class="mt-16">
      <h2 class="font-poppins font-bold text-[75.8px] text-[#47423B] lowercase mb-6">
        send us an email
      </h2>
      <div class="flex items-center">
