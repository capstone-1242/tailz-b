...
<nav class="border-b-2 border-cream py-[20px] lg:py-[30px] mx-[24px] lg:mx-[90px] mb-[60px] lg:mb-[130px]" aria-label="Breadcrumb">
	<ol class="flex items-center font-worksans text-[14px] md:text-[16px] text-darkbrown">
		...
		<li aria-current="page">
			<span class="uppercase font-bold">Training</span>
		</li>
	</ol>
</nav>
						...
						<?php if (!empty($puppyClasses)) :
							foreach ($puppyClasses as $class) : ?>
								<div class="bg-white p-6 rounded-[20px]" role="region" aria-label="<?php echo esc_attr($class['title']); ?> package">
									...
									<?php
									$topics = array();
									if (!empty($class['topics']['topic_1'])) {
										$topics[] = $class['topics']['topic_1'];
									}
									if (!empty($class['topics']['topic_2'])) {
										$topics[] = $class['topics']['topic_2'];
									}
									if (!empty($class['topics']['topic_3'])) {
										$topics[] = $class['topics']['topic_3'];
									}
									if (!empty($topics)) : ?>
										<div class="mb-6">
